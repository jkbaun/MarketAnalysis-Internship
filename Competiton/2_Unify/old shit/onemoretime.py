...
def robust_relational_unification(raw_df):
    ...
    # ---------------------------------------------------------
    # Filter to only the most recent snapshot to prevent historical row multiplication
    ...
    for _, row in df_current.iterrows():
        ...
        # Strip variant specs from the parent title to prevent matching confusion
    ...
    # ---------------------------------------------------------
    # STEP 3: STRICT PARENT UPK UNIFICATION 
    # ---------------------------------------------------------
    parent_pool = {}
    parent_counter = 1000
    ...
    # Group by the clean_parent_title to match the base product ONCE
    ...
    # ---------------------------------------------------------
    # STEP 4: DETERMINISTIC CHILD UPK GENERATION
    # ---------------------------------------------------------
    # Child UPKs generated strictly based on Parent UPK + Variant Spec
